...
- **$开头**：以$开头执行某个subagent(如$code-reviewer)
...
- 运行 iflow 后选择 "Login with iFlow" 登录
- CLI 会自动打开浏览器跳转到心流平台
- 完成注册/登录后授权 iFlow CLI
- 自动返回终端，开始使用
...
- 访问[心流官网](https://iflow.cn/?spm=54878a4d.2ef5001f.0.0.7c1257832yovzX&open=setting)完成注册
- 在用户设置页面生成 API KEY
- 在 iFlow CLI 中选择 API Key 登录并输入密钥
...
- [基础用法](/cli/examples/basic-usage) - 掌握日常使用技巧（10分钟）
- [交互模式](/cli/features/interactive) - 学习高效交互方式（15分钟）
- [MCP扩展](/cli/examples/mcp) - 扩展AI能力（15分钟）
- [最佳实践](/cli/examples/best-practices) - 提升工作效率（20分钟）
